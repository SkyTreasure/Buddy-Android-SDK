...
class BlobDataModel extends BaseDataModel {
	...
	public void add(String friendlyName, String appTag, double latitude, double longitude, 
			String contentType, byte[] blobData, final OnCallback<Response<Boolean>> callback)
	{
	...
	public void add(String friendlyName, String appTag, double latitude, double longitude, 
			String contentType, InputStream blobData, final OnCallback<Response<Boolean>> callback)
	{
	...
	public void getList(long userId, int recordLimit, final OnCallback<ListResponse<Blob>> callback){
		BuddyWebWrapper.Blobs_Blob_GetList(client, authUser, userId, recordLimit, new OnResponseCallback(){
	...
	public void getMyList(int recordLimit, final OnCallback<ListResponse<Blob>> callback){
		BuddyWebWrapper.Blobs_Blob_GetMyList(client, authUser, recordLimit, new OnResponseCallback(){
